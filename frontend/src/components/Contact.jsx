...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gray-900/50 backdrop-blur-sm overflow-hidden">
          ...
          <div className="bg-gray-800/50 p-8 rounded-2xl border border-gray-700/50 shadow-xl">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-purple-200">shivam2110207@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-purple-200">INDIA</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="v" className="text-gray-400 hover:text-purple-400">
                  <span className="sr-only">Twitter</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://github.com/maxtro64" className="text-gray-400 hover:text-purple-400">
                ...
                <a href="https://www.linkedin.com/in/shivam-yadav-b87300294/" className="text-gray-400 hover:text-purple-400">
